import './getIconsStyle.module.css';
import { HeartFill, Heart, StarFill, Star } from "react-bootstrap-icons";
export const getLifeIcons = (life) => {
    if (life === 3) {
        return (<div className="hearts-wrap">
...
export const getStarsIcons = (assertPercetage) => {
    if (assertPercetage > 89) {
        return (<div className="stars-wrap">
